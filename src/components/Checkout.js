    ...
    <Box display="flex" flexDirection="column">
      ...
      <Stack direction="row" my="1rem">
        <Button
          variant="contained"
          onClick={async () => {
            await addAddress(token, newAddressData);
          }}
        >
          Add
        </Button>
      ...
      <Grid container>
        <Grid item xs={12} md={9}>
          <Box className="shipping-container" minHeight="100vh">
            ...
            {!newAddressData.isAddingNewAddress ? (
        <Button
          color="primary"
          variant="contained"
          id="add-new-btn"
          size="large"
          onClick={() => {
            setNewAddressData((currNewAddress) => ({
              ...currNewAddress,
        ...
        <AddNewAddressView
          ...
          handleNewAddress={setNewAddressData}
